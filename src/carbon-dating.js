...
module.exports = function dateSample(sampleActivity) {
  ...
  if (typeof sampleActivity === 'string') {
    ...
    if (typeof sampleActivity === 'number' && 
      ...
      //?
      //? HALF_LIFE_PERIOD  полураспад  Либби в статье 1949 - (5720 ± 47)  -> 
      //?                                                     (5568 ± 30 лет) ->
      ...
      //! в 5730 лет в var 1 и 2 использовано число 5731.23
      //?------------------------------------------------------------
      //* variant 1 -> return Math.ceil((getBaseLog(Math.E, MODERN_ACTIVITY) - getBaseLog(Math.E, sampleActivity)) * 8267);
      //* variant 2 -> 
      return Math.ceil((getBaseLog(2, sampleActivity/MODERN_ACTIVITY)) * -5731.23);
